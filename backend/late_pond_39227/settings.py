"""
Django settings for late_pond_39227 project.
...
ROOT_URLCONF = 'late_pond_39227.urls'
...
WSGI_APPLICATION = 'late_pond_39227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_pond_39227 API",
    "DESCRIPTION": "API documentation for late_pond_39227 App",
    "VERSION": "v1",
}
